...
struct BeforeSleepFeelingView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [.blueGray, .blueGray, .black]), startPoint: .top, endPoint: .bottom)
            ...
            VStack (spacing: 20){
                ...
                Text("How are feeling today?")
                    ...
                    .foregroundColor(.white)
                Spacer()
                RoundedFeelingView(category: "Good", feelEmoji: "😊", color: Color.lightGreen, action: {
                    selectedFeeling = selectedFeeling == "Good" ? nil : "Good"
                }, isSelected: selectedFeeling == "Good")
