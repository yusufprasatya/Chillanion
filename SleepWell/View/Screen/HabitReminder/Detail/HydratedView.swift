                        ...
                        RoundedButton(
                            ...
                            action: {
                                ...
                                if isRecommendedReminderActive{
                                    ...
                                    UserNotificationService.shared.scheduleNotification(identifier: "stayHydrated", type: "date", timeInterval: nil, title: "Stay Hydrated", body: "Stay peppy! Sip water all day to beat fatigue!💧🥰", notifHour: triggerDateComponents)
                                ...
                                if isManualReminderActive {
                                    ...
                                    UserNotificationService.shared.scheduleNotification(identifier: "stayHydrated", type: "date", timeInterval: nil, title: "Stay Hydrated", body: "Stay peppy! Sip water all day to beat fatigue!💧🥰", notifHour: components)
                                } else if isManualReminderActive {
                                    UserNotificationService.shared.disableNotifications(identifiers: ["stayHydrated"])
                                    isManual = false
                                }
                                
                                dailyHabitViewModel.updateReminder(name: "Stay Hydrated", isRemind: isRemind, isManual: isManual)
