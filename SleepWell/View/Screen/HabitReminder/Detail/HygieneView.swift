                        ...
                        RoundedButton(
                            ...
                            action: {
                                if isRecommendedReminderActive{
                                    ...
                                    UserNotificationService.shared.scheduleNotification(identifier: "hygiene", type: "date", timeInterval: nil, title: "Hygiene", body: "Hygiene time! Bedtime buddies for relaxed sleep and a healthier you! 💤💆‍♀️", notifHour: triggerDateComponents)
                                } else if isRecommendedReminderActive == false {
                                    UserNotificationService.shared.disableNotifications(identifiers: ["hygiene"])
                                    isRemind = false
                                }
                                ...
                                if isManualReminderActive {
                                    ...
                                    UserNotificationService.shared.scheduleNotification(identifier: "hygiene", type: "date", timeInterval: nil, title: "Hygiene", body: "Hygiene time! Bedtime buddies for relaxed sleep and a healthier you! 💤💆‍♀️", notifHour: components)
                                } else if isManualReminderActive {
                                    UserNotificationService.shared.disableNotifications(identifiers: ["hygiene"])
                                    isManual = false
                                }
                                
                                dailyHabitViewModel.updateReminder(name: "Hygiene", isRemind: isRemind, isManual: isManual)
